<?php   
    ...
    include_once 'C_savetraining.php';
    ...
    <body>
      <header>
        <ul>
            ...
            <li><a href="../coachMypage.php">STARTSIDA</a></li>
            <li><a href="../chatOptions.php" class="active">LIVEFORUM</a></li>
            <li><a href="../logoutCoach.php">LOGGA UT</a></li>
        </ul>
      </header>
        <a id = "Tillbaka" href="../chatOptionsCoach.php">Tillbaka</a><br>
        <div id= "welcome">
            <h2>Hej Coach <?php echo $_SESSION['User']; ?>!</h2><br>
        </div>
        <div id="chatcontainer2">
            <p1> Hälsotema: Träning </p1><br><br>
            <div id="chatbox">
                <?php
                    $getClientData = "SELECT * FROM Client_Message WHERE forum_type = 'training' AND coachMsgID IS NULL";
