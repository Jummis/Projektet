...
<html>
            ...
            <div id = "wrapperHistorik">
                ...
                <div id="historikbox">
                    <?php
                        ...
                        $notanswered = "SELECT * FROM Archive_Message_Client WHERE forum_type = 'alcohol' AND clientID = '$userID' AND coachMsgID IS NULL";
                        $na = $connection->query($notanswered);

                        //hämtar besvarade meddelanden
                        $answer = "SELECT * FROM Archive_Message_Client WHERE forum_type = 'alcohol' AND clientID = '$userID' AND coachMsgID IS NOT NULL";
    ...
    <body>
        ...
        <div id = "wrapper4">
            <div id = "wrapperHistorik">
                <p id="rubrikLoggbok">Din historik: Kost</p>
                <div id="historikbox">
                    <?php
                        $name = $_SESSION['User'];
                        $userID = $_SESSION['ID'];
                        ...
                        //obesvarade meddelanden
                        $notanswered = "SELECT * FROM Archive_Message_Client WHERE forum_type = 'food' AND clientID = '$userID' AND coachMsgID IS NULL";
                        $na = $connection->query($notanswered);

                        //hämtar besvarade meddelanden
                        $answer = "SELECT * FROM Archive_Message_Client WHERE forum_type = 'food' AND clientID = '$userID' AND coachMsgID IS NOT NULL";
                        $a = $connection->query($answer);
