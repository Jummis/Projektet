            ...
            <div id = "wrapperLogg">
                ...
                <div id="historikbox">
                    <?php
                        ...
                        $notanswered = "SELECT * FROM Archive_Message_Client WHERE forum_type = 'sleep' AND clientID = '$userID' AND coachMsgID IS NULL";
                        $na = $connection->query($notanswered);

                        //hämtar besvarade meddelanden
                        $answer = "SELECT * FROM Archive_Message_Client WHERE forum_type = 'sleep' AND clientID = '$userID' AND coachMsgID IS NOT NULL";
