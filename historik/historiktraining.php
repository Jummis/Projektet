...
<html>
    ...
    <body>
        ...
        <div id = "wrapper4">
            <div id = "wrapperLogg">
                <p id="rubrikLoggbok">Din historik: Träning</p>
                <div id="historikbox">
                    <?php
                        $name = $_SESSION['User'];
                        $userID = $_SESSION['ID'];
                        ...
                        $notanswered = "SELECT * FROM Archive_Message_Client WHERE forum_type = 'training' AND clientID = '$userID' AND coachMsgID IS NULL";
                        $na = $connection->query($notanswered);

                        //hämtar besvarade meddelanden
                        $answer = "SELECT * FROM Archive_Message_Client WHERE forum_type = 'training' AND clientID = '$userID' AND coachMsgID IS NOT NULL";
