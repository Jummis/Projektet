...
<html>
    ...
    <body>
        <header>
            ...
            <div id "logoAll">
                ...
                <div id="chatcontainer">
                    <p3> Ditt valda hälsotema är: ALKOHOL/TOBAK </p3>
                    <div id="chatbox">
                        <?php
                            $name = $_SESSION['User'];
                            $userID = $_SESSION['ID'];
                            ...
                            $answer = "SELECT * FROM Client_Message WHERE forum_type = 'alcohol' AND clientID = '$userID' AND coachMsgID IS NOT NULL";
        ...
        <a href='archivealcohol.php'><input type="submit" name="closeForumKnapp" value="Avsluta forum och arkivera konsversationen" id="closeForumKnapp"></a>
    </body>
