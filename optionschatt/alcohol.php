...
<html>
    ...
    <ul>
        ...
        <a id = "Tillbaka" href="archivealcohol.php">Avsluta och arkivera konversation</a>
        <div id= "welcome">
        ...
        <div id="chatcontainer">
            ...
            <div id="chatbox">
                <?php
                    ...
                    $answered = "SELECT * FROM Client_Message WHERE forum_type = 'alcohol' AND clientID = '$userID' AND coachMsgID IS NOT NULL";
                    $a = $connection->query($answered);

                    //obesvarade meddelanden
                    $notanswered = "SELECT * FROM Client_Message WHERE forum_type = 'alcohol' AND clientID = '$userID' AND coachMsgID IS NULL";
                    $na = $connection->query($notanswered);

                    //hämtar besvarade meddelanden
                    $messageID = "SELECT * FROM Client_Message WHERE forum_type = 'alcohol' AND clientID = '$userID' AND coachMsgID IS NOT NULL";
