<?php
        ...
        SELECT * FROM Client_Message WHERE clientID = '$ID' AND forum_type = '$alcohol'";
        $sqlarchive = $connection->query($sqlinsertarchive);

        //tar ut hälsoklientens meddelanden som arkiverades
        $sqlselect = "SELECT * FROM Client_Message WHERE clientID = '$ID' AND forum_type = '$alcohol'";
        ...
        //Ta bort meddelanden
        $sqldelete = "DELETE FROM Client_Message WHERE clientID = '$ID' AND forum_type = '$alcohol'";
