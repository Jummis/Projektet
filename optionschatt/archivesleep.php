...
date_default_timezone_set('Europe/Stockholm');
        ...
        SELECT * FROM Client_Message WHERE clientID = '$ID' AND forum_type = '$sleep'";
        $sqlarchive = $connection->query($sqlinsertarchive);

        //tar ut hälsoklientens meddelanden som arkiverades
        $sqlselect = "SELECT * FROM Client_Message WHERE clientID = '$ID' AND forum_type = '$sleep'";
        ...
        //Ta bort meddelanden
        $sqldelete = "DELETE FROM Client_Message WHERE clientID = '$ID' AND forum_type = '$sleep'";
