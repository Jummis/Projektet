...
<html>
    ...
    <header>
        ...
        <a id = "Tillbaka" href="archivekost.php">Avsluta och arkivera konversation</a>
        <div id= "welcome">
        ...
        <div id="chatcontainer">
            <p3> Ditt valda hälsotema är: KOST </p3>
            <div id="chatbox">
                <?php
                    $name = $_SESSION['User'];
                    $userID = $_SESSION['ID'];
                    ...
                    $notanswered = "SELECT * FROM Client_Message WHERE forum_type = 'food' AND clientID = '$userID' AND coachMsgID IS NULL";
                    $na = $connection->query($notanswered);

                    //hämtar besvarade meddelanden
                    $answer = "SELECT * FROM Client_Message WHERE forum_type = 'food' AND clientID = '$userID' AND coachMsgID IS NOT NULL";
            ...
            <div class="historyButtons">
                ...
                <textarea placeholder="Vänligen skriv ditt meddelande här" name="userkostmsg" id="usermsg"></textarea><br>
                <input type="submit" name="submitmsg" value="SKICKA" id="sendmessage">
                <a href = "kost.php"> <img id = "update" src = "../assets/img/update-arrows.png"></a>
                </form>
                
            </div> 
        </div>
        <a href='../userHome.php'><input type="submit" name="closeForumKnapp" value="LÄMNA FORUM" id="closeForumKnapp"></a>
    </body>
    <footer>
